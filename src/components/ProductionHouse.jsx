...
const ProductionHouse = () => {
    ...
    return (
        <div className="mt-2 px-16 py-4 flex gap-2 md:gap-5">
            {productions.map((production) => (
                <div key={production.id} className="relative rounded-lg border-2 border-gray-600 transition-all hover:scale-105 hover:border-gray-100 overflow-hidden shadow-xl shadow-black cursor-pointer select-none">
